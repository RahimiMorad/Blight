...
<div class="post col-xl-6">
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		<div class="post-thumbnail"><a href="<?php the_permalink(); ?>"><img src=" <?php  the_post_thumbnail_url('post-thumb' ); ?> " alt="..." class="img-fluid"></a></div>
		<div class="post-details">
			<div class="post-meta d-flex justify-content-between">
				<div class="date meta-last"><?php echo get_the_date( 'j F | Y' ); ?></div>
			...
			<footer class="post-footer d-flex align-items-center"><a href="#"
					...
					<div class="avatar">
						<?php echo get_avatar( get_the_author(), 70,'','',array('class' => 'img-fluid rounded-circle') ); ?>
					</div>
